...
async function playQueue(){
  if(queue.length > 0){
    const ytdlProcess = await ytdl(queue[0].url,
        {
            dumpSingleJson: true,
    ...
    ); //Didn't work with old package but could we store the downloaded url in the queue?
    ...
    //console.log(JSON.stringify(audioResource));
